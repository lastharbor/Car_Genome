...
// Release signing is optional: drop a keystore.properties next to this file
// (see README) and the release build picks it up automatically.
...
android {
    ...
    // Room migration tests read the exported schemas straight out of the APK.
...
dependencies {
    implementation(project(":core:vin"))
